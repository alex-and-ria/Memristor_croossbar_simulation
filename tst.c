...
int main(int argc, char**argv){
     ...
     if(argc==3 && strcmp(argv[1],"debug_mode1")==0){
     	dbg=mode1;
     	dense_rdct(row,(unsigned long long int*)(&rw_),col,(unsigned long long int*)(&cl_),val,(unsigned long long int*)(&vl_), &len1,&ln_, nds_td, &nds_n,1.,nds_td1,nds_n1, &n_th,max_m_sz,dbg,atoi(argv[2]),M_DIM,N_DIM);
     	...
     	dense_rdct(row,(unsigned long long int*)(&rw_),col,(unsigned long long int*)(&cl_),val,(unsigned long long int*)(&vl_), &len1,&ln_, nds_td, &nds_n,atof(argv[1]),nds_td1,nds_n1,&n_th,max_m_sz,-1,0,M_DIM,N_DIM);
          ...
          dbg=mode_1_2_3;
          dense_rdct(row,(unsigned long long int*)(&rw_), col, (unsigned long long int*)(&cl_), val, (unsigned long long int*)(&vl_), &len1,&ln_, nds_td, &nds_n,/*atof(argv[1])*/0, nds_td1, nds_n1, &n_th,max_m_sz, mode_1_2_3,0,M_DIM,N_DIM);
