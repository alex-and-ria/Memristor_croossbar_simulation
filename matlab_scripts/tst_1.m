...
max_m_sz=2;
fprintf(f_id,"#define fl_pl 1\nunsigned int m_val=%d;\n",m);
fprintf(f_id,"#define fl_mem_pl 1\n");
fprintf(f_id,"#define fl_nm ""OpenMP_timing/11OpenMP_tst_%dx%d_(%d).csv""\n",m,n,max_m_sz);
fprintf(f_id,"#define fl_app 1\n");
