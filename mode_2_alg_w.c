...
void mode_2_alg_w(node** node_arr,unsigned int *nds_td, unsigned int nds_n, node* node_hd, unsigned int max_nds, unsigned int** rw, unsigned int** cl, double **vl, unsigned int *ln, unsigned char out_fl,mode_3_param* mode3_inp,unsigned int shift,int fd, unsigned int* max_offst_elm){//nds_n0=0 as terminat, set max size at the beggining
